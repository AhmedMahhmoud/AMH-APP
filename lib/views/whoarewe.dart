...
class _WhoAreWeState extends State<WhoAreWe> {
  ...
  List<Widget> words = [
    ...
    AmhWords(
      ...
      word:
          " ان التزامنا بأعلى المقاييس العالميه لحوكمه الشركات و الممارسات المهنيه العالميه يبقى دوما في صميم عملنا و بهذا استطعنا ان نطور اسلوبنا فى الإداره و ممارستنا و اجراءاتنا بحيث نتمكن من تقديم كل ما هو مميز",
    )
  ];
